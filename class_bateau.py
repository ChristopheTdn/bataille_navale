class Bateau():
    """
    gestion de la creation des bateau avec leur nom, identifiant taille et position dans la grille
    ...
    def place_bateau (self, grille,largeur,hauteur):
        ...
        while place_bateau:
            ...
            if grille[(chr(64+X), Y)] != ".":
                ...
                if random.randint(1, 2) == 1 and (X + self.taille <= largeur):  # horizontal
